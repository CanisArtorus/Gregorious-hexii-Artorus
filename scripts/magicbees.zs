...
*/
recipes.addShaped(backpackThaumaturge, [
	[cotton, <ore:dustVinteum>, cotton],
	[leather, <ore:gemAmber>, leather],
	[leather, leather, leather] ]);
Carpenter.removeRecipe(backpackThaumaturgeT2);
Carpenter.addRecipe(backpackThaumaturgeT2, [
	[silk, <ore:ringBronze>, silk],
	[silk, silk, silk],
	[silk, silk, silk] ],
	<liquid:seedoil> * 500, 600, backpackThaumaturge);
